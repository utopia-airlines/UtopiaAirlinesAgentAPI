...
public class BookingController {
	...
	public ResponseEntity<Ticket> getAllBranchCopies(@PathVariable final int flight,
			@PathVariable final int row, @PathVariable final String seat,
			@RequestBody final User user) {
		HttpEntity<User> body = new HttpEntity<>(user);
		String url = "http://" + hostName + ":" + port + root + "/book/flights/" + flight +
				"/rows/" + row + "/seats/" + seat;
	...
	public ResponseEntity<Ticket> acceptPayment(@PathVariable final int flight,
		...
		String url = "http://" + hostName + ":" + port + root + "/pay/flights/" + flight +
				"/rows/" + row + "/seats/" + seat;
	...
	public ResponseEntity<Object> extendTimeout(@PathVariable final int flight,
			@PathVariable final int row, @PathVariable final String seat) {
		String url = "http://" + hostName + ":" + port + root + "/extend/flights/" + flight +
				"/rows/" + row + "/seats/" + seat;
	...
	public ResponseEntity<Ticket> getBookingDetails(@PathVariable final int flightId,
		...
		String url = "http://" + hostName + ":" + port + root + "/details/flights/" + flightId +
				"/rows/" + row + "/seats/" + seatId;
